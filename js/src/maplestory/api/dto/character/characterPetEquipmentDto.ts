...
class CharacterPetEquipmentDto {
  ...
  constructor(obj: CharacterPetEquipmentDtoBody) {
    ...
    this.pet1AutoSkill = new CharacterPetEquipmentAutoSkillDto(
      pet_1_auto_skill,
    );
    ...
    this.pet2AutoSkill = new CharacterPetEquipmentAutoSkillDto(
      pet_2_auto_skill,
    );
    ...
    this.pet3AutoSkill = new CharacterPetEquipmentAutoSkillDto(
      pet_3_auto_skill,
    );
