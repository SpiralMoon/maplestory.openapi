export type UnionRaiderDtoBody = {
  date: string | null;
...
export type UnionRaiderInnerStatDtoBody = {
  stat_field_id: string;
  stat_field_effect: string;
};

export type UnionRaiderBlockDtoBody = {
  block_type: string;
  block_class: string;
  block_level: string;
...
export type UnionRaiderBlockControlPointDtoBody = {
  x: number;
  y: number;
};

export type UnionRaiderBlockPositionDtoBody = {
  x: number;
  y: number;
};

export type UnionRaiderPresetDtoBody = {
  union_raider_stat: string[];
  union_occupied_stat: string[];
  union_inner_stat: UnionRaiderInnerStatDtoBody[];
  union_block: UnionRaiderBlockDtoBody[];
