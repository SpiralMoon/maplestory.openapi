...
class CharacterHyperStat(BaseModel, BaseCharacterHyperStat):
    ...
    Attributes:
        ...
        use_preset_no (str): Active preset number
        use_available_hyper_stat (int): Maximum available Hyper Stat points
        hyper_stat_preset_1 (list[CharacterHyperStatPreset]): Hyper Stat information for preset 1
        hyper_stat_preset_1_remain_point (int): Remaining Hyper Stat points for preset 1
        hyper_stat_preset_2 (list[CharacterHyperStatPreset]): Hyper Stat information for preset 2
        hyper_stat_preset_2_remain_point (int): Remaining Hyper Stat points for preset 2
        hyper_stat_preset_3 (list[CharacterHyperStatPreset]): Hyper Stat information for preset 3
        hyper_stat_preset_3_remain_point (int): Remaining Hyper Stat points for preset 3
    """
    date: datetime | None
    character_class: str
    use_preset_no: str
