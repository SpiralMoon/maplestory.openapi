...
namespace MapleStory.Test.KMS.Ranking
{
    ...
    public class TestGetGuildRanking
    {
        ...
        {
            var response = await api.GetGuildRanking(worldName: null, rankingType: 0, guildName: "리더", page: null);
        ...
        {
            var response = await api.GetGuildRanking(worldName: "스카니아", rankingType: 0, guildName: "리더", page: null);
