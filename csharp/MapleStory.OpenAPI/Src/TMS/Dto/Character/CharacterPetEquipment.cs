...
namespace MapleStory.OpenAPI.TMS.DTO
{
    ...
    public class CharacterPetEquipmentDTO : Base.CharacterPetEquipmentDTO<CharacterPetEquipmentItemDTO, CharacterPetEquipmentAutoSkillDTO>
    {
        ...
        [JsonConverter(typeof(NullAsEmptyConverter))]
        public List<CharacterPetEquipmentPotentialDTO> Pet1Potential { get; set; } = new();
        ...
        [JsonConverter(typeof(NullAsEmptyConverter))]
        public List<CharacterPetEquipmentPotentialDTO> Pet2Potential { get; set; } = new();
        ...
        [JsonConverter(typeof(NullAsEmptyConverter))]
        public List<CharacterPetEquipmentPotentialDTO> Pet3Potential { get; set; } = new();
    }
    ...
    public class CharacterPetEquipmentPotentialDTO
    {
        ...
        public string PotentialStep { get; set; }
        ...
        public string? PotentialIncrease1 { get; set; }
        ...
        public string? PotentialIncrease2 { get; set; }
    }
