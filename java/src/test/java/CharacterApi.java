...
public class CharacterApi {
    ...
    void getCharacter() throws IOException {
        String nickname = "아델";
        CharacterDTO response = api.getCharacter(nickname);
    ...
    void getCharacterList() throws IOException {
        CharacterListDTO response = api.getCharacterList();
        System.out.println(response.toString());
    }
    ...
    void getCharacterHyperStat() throws IOException {
        CharacterHyperStatDTO response = api.getCharacterHyperStat(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterPropensity() throws IOException {
        CharacterPropensityDTO response = api.getCharacterPropensity(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterAbility() throws IOException {
        CharacterAbilityDTO response = api.getCharacterAbility(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterCashItemEquipment() throws IOException {
        CharacterCashItemEquipmentDTO response = api.getCharacterCashItemEquipment(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterSymbolEquipment() throws IOException {
        CharacterSymbolEquipmentDTO response = api.getCharacterSymbolEquipment(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterSetEffect() throws IOException {
        CharacterSetEffectDTO response = api.getCharacterSetEffect(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterAndroidEquipment() throws IOException {
        CharacterAndroidEquipmentDTO response = api.getCharacterAndroidEquipment(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterSkill() throws IOException {
        String skillGrade = "0";
        CharacterSkillDTO response = api.getCharacterSkill(ocid, skillGrade);
        System.out.println(response.toString());
    }
    ...
    void getCharacterLinkSkill() throws IOException {
        CharacterLinkSkillDTO response = api.getCharacterLinkSkill(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterHexaMatrix() throws IOException {
        CharacterHexaMatrixDTO response = api.getCharacterHexaMatrix(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterHexaMatrixStat() throws IOException {
        CharacterHexaMatrixStatDTO response = api.getCharacterHexaMatrixStat(ocid);
        System.out.println(response.toString());
    }
    ...
    void getCharacterDojang() throws IOException {
        CharacterDojangDTO response = api.getCharacterDojang(ocid);
        System.out.println(response.toString());
    }
}
